...
const externalCoverage = new Map([
  ...
  ["./samples/browser-bench-compose", verifier("bench/frameworks.config.mjs", "compose-web")],
  ...
  ["./samples/browser-game-of-life-compose", verifier("scripts/verify-browser.mjs", "compose-html")],
